<x-layout>
    ...
    <!-- process-six -->
    <section class="process-six p_relative sec-pad centred">
        <div class="auto-container">
            <div class="sec-title-six p_relative d_block mb_100">
                <h4 class="p_relative d_block fs_17 uppercase lh_30 fw_sbold mb_15">Process</h4>
                <h2 class="d_block fs_40 lh_52 fw_bold">Always Work Done by The <br />Following Process</h2>
            </div>
            <div class="row clearfix">
                <div class="col-lg-4 col-md-6 col-sm-12 processing-block">
                    <div class="processing-block-five">
                        <div class="inner-box p_relative d_block pl_30 pr_30">
                            <div class="line-shape p_absolute tran_5 t_35" style="background-image: url(assets/images/shape/shape-188.png);"></div>
                            <div class="count-box p_relative d_iblock w_70 h_70 lh_70 centred b_radius_50 fs_18 fw_sbold font_family_inter z_1 tran_5 mb_60">
    ...
    <!-- clients-one -->
    <section class="clients-one light p_relative pt_100 pb_100">
        <div class="pattern-layer p_absolute l_0 t_0" style="background-image: url(assets/images/shape/shape-190.png);"></div>
        <div class="auto-container">
